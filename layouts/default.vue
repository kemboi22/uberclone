...
import {Bars3CenterLeftIcon, MagnifyingGlassIcon} from "@heroicons/vue/20/solid";
  ...
  <div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a class="flex items-center justify-between mr-4" href="https://flowbite.com">
            <img
                alt="Flowbite Logo"
                class="mr-3 h-8"
                src="https://flowbite.s3.amazonaws.com/logo.svg"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Uber </span>
          </a>
          <form action="#" class="hidden md:block md:pl-2" method="GET">
    ...
    >
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <form action="#" class="md:hidden mb-2" method="GET">
